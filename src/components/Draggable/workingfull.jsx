  ...
  const [zoom, setZoom] = useState(1)
    ...
    const onCropComplete = (croppedArea, croppedAreaPixels) => {
      ...
      const showCroppedImage = async () => {
        console.log("hurray", selectedImageUrl)
          ...
          if (indexOfObjectToUpdate !== -1) {
            ...
            const updatedObject = {
              ...
              url: croppedImage,                   // Update the URL property
            };
...
//   });
  ...
  const downloadCollage = async() =>{
      ...
      const link2Download = canvas.toDataURL('image/jpg')
...
//   }
  ...
  return (
    ...
    >
        ...
        />
    <div style={{zIndex:999, position:"absolute", bottom : 0}}>
    <button style={{zIndex:999}} onClick={showCroppedImage}>Apply</button>
      <button style={{zIndex:999}} onClick={closeModal}>Close</button>
